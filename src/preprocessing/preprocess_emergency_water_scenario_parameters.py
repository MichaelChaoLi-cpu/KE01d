...
add("General Access Distance", [("250 m scenario", 250), ("500 m scenario", 500), ("1,000 m scenario", 1000)], "m", "researcher_defined_sensitivity", "research scenario", "Co-equal nominal-access sensitivities; none is a baseline or reference distance, and none represents observed collection behavior.")
add("Extended Access Distance Diagnostic", [("2,000 m diagnostic", 2000), ("5,000 m diagnostic", 5000)], "m", "researcher_defined_sensitivity", "research scenario", "Extended allocation and mapping diagnostics only; not walking standards, baselines, or reference distances.")
